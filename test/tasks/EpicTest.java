...
class EpicTest {
    ...
    @Test
    void getEpicSubtasksIdShouldReturnSubtaskIds() {
        // prepare
    ...
    @Test
    void addSubtaskShouldNotAddNullSubtask() {
        // prepare
        Epic epic1 = new Epic(1, "epic_1", "epic_description_1");
    ...
    @Test
    void replaceSubtasksShouldReplaceSubtaskIdsList() {
        // prepare
        Epic epic1 = new Epic(1, "epic_1", "epic_description_1");
        Subtask subtask = new Subtask(2, "subtask_1", "subtask_description_1");
    ...
    @Test
    void checkEqualsEpicShouldBeEqualsEpic() {
        // prepare
        Epic epic1 = new Epic(1, "epic_1", "epic_description_1");
